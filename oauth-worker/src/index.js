/**
 * Sveltia CMS Authenticator — worker de login con GitHub para el panel /admin.
 *
 * Código OFICIAL de Sveltia (licencia MIT), incluido aquí tal cual para poder
 * desplegarlo sin depender de terceros y con una versión revisada y fijada.
 *   Fuente:  https://github.com/sveltia/sveltia-cms-auth  (v0.1.0)
 *   Conviene revisar el repositorio de vez en cuando por si hay parches de seguridad.
 *
 * Necesita (ver README de esta carpeta):
 *   - Secreto  GITHUB_CLIENT_ID
 *   - Secreto  GITHUB_CLIENT_SECRET
 *   - Variable ALLOWED_DOMAINS   (dominios autorizados a usar este worker)
 */
